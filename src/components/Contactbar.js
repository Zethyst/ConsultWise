        ...
        <>
            <nav className="h-12 bg-[#002e5b] flex gap-[42rem]" style={{ width: "101%" }}>
                <ul className="contact-info flex h-full items-center">
                    <li className="text-white w-24 ml-10 relative flex"><i class="fa-solid fa-phone mr-2 mt-1" style={{color:"#FBBA42"}}></i>8318876136</li>
                    <li className="text-white w-44 ml-16 relative flex"><i class="fa-solid fa-envelope mr-2 mt-1" style={{color:"#FBBA42"}}></i>zethyst@protonmail.com</li>
                </ul>
